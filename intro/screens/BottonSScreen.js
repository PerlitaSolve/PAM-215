...
export default function BottonSScreen() {
        ...
        <GestureHandlerRootView style={styles.rootView}>
            ...
            >
                <BottomSheetView style={styles.BView}>
                    ...
                    <Text style={styles.sheetText}> Descripción: Comodidad y estilo </Text>
...
const styles = StyleSheet.create({
    ...
    buttonVerInfo: {
        backgroundColor: '#a2d3f3ff',
        paddingVertical: 12,
        paddingHorizontal: 24,
        borderRadius: 8,
    },
    buttonComprar: {
        backgroundColor: '#9ed486ff',
        paddingVertical: 12,
        paddingHorizontal: 24,
        borderRadius: 8,
        marginTop: 20,
